...
public class SpawnCubes : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(Input.GetKeyDown(KeyCode.P) && p_key_to_pause_game)
        {
        ...
        if (breakTimer <= actBreakTime) // activate breakWindow or update the remaining break time on the already active break window
        {
